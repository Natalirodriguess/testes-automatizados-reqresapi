Feature: Buscar usuario por id no endpoint https://reqres.in/api/users/{id}

  Scenario: Buscar usurio a partir de um id valido

    Given que o id informado eh 1

    When eu faco uma requisição do tipo GET para users/{id}
